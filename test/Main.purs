...
unsafeApplySpec =
  it "unsafeApplyProps" do
    let
      props = { ok: "1", second: "2", ios: { iosProp: 12 }, android: { whatever: "something" } }
    let
      after = AppliedProps { ok: "1", second: "2", iosProp: 12, whatever: "something" }
